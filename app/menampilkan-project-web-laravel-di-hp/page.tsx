...
export const metadata: Metadata = {
    title: 'Cara Menampilkan Project Laravel di HP - Praktis & Cepat',
    description: 'Jangan ribet lagi! Pelajari cara mudah menampilkan project Laravel di HP Anda dengan langkah praktis.',
    keywords: 'Laravel, menampilkan Laravel di HP, coding Laravel, project Laravel di mobile',
    openGraph: {
      title: 'Cara Menampilkan Project Laravel di HP - Praktis & Cepat',
      description: 'Langkah praktis untuk menampilkan project Laravel di HP tanpa repot. Cocok untuk developer.',
      url: 'https://bytemindsoftware.vercel.app/cara-menampilkan-project-laravel-di-hp',
    },
};
